...
app.post('/employees', (req, res) => {
    ...
    dataAccess.createEmployee(name, role, status, function (err) {
      if (err) {
...
app.get('/employees/:id', (req, res) => {
    ...
    dataAccess.getEmployeeById(id, (err, row) => {
      if (err) {
...
app.put('/employees/:id', (req, res) => {
    ...
    dataAccess.updateEmployee(id, name, role, status, function (err) {
      if (err) {
...
app.delete('/employees/:id', (req, res) => {
    ...
    dataAccess.deleteEmployee(id, function (err) {
      if (err) {
...
app.post('/employees/:id/assign-role', (req, res) => {
    ...
    dataAccess.assignRoleToEmployee(id, role, function (err) {
      if (err) {
...
app.get('/admin/total-employees', (req, res) => {
    dataAccess.getTotalEmployees((err, row) => {
      if (err) {
...
app.get('/admin/total-roles', (req, res) => {
    dataAccess.getTotalRoles((err, row) => {
      if (err) {
...
app.post('/admin/create-role', (req, res) => {
    ...
    dataAccess.createRole(name, (err) => {
      if (err) {
...
app.delete('/admin/delete-role/:name', (req, res) => {
    ...
    dataAccess.deleteRole(name, function (err) {
      if (err) {
...
app.put('/admin/update-status/:id', (req, res) => {
    ...
    dataAccess.updateEmployeeStatus(id, status, function (err) {
      if (err) {
...
app.get('/employees/:id/details', (req, res) => {
    ...
    dataAccess.getEmployeeDetails(id, (err, row) => {
      if (err) {
